...
const OrderData = ({
  ...
  const ProductItem = ({ product, details, idx }) => {
    const { itemTotal, saved, originalTotal, rawSaved, discountPercent } =
      details;
  ...
  const OrderSummaryCard = ({ title, value, icon: Icon, color = "blue" }) => {
    const colorClasses = {
      blue: {
    ...
    return (
      <div
        className={`p-4 rounded-xl border ${classes.bg} border-gray-200 dark:border-gray-700`}
      >
        <div className="flex items-center gap-3">
          <div
            className={`w-10 h-10 ${classes.iconBg} rounded-lg flex items-center justify-center`}
          >
    ...
    <div className="space-y-6">
      ...
      <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        <div
          ...
          onClick={() =>
            window.innerWidth < 768 && setShowActions(!showActions)
          }
        >
