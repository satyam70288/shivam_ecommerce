              ...
              <div key={step.id} className="flex items-center gap-2">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium
                  ${isCompleted ? "bg-blue-600 text-white" : 
                    isActive ? "bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 border-2 border-blue-500" : 
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                ₹{(getTotalAmount() * 1.18).toFixed(2)}
              </p>
              <p className="text-xs text-green-600 dark:text-green-400 mt-0.5">
                You save ₹{items.reduce((sum, item) => sum + (item.discountAmount * item.quantity), 0).toFixed(2)}
              </p>
            </div>
          </div>
        </div>
